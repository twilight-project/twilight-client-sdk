...
fn market_order_service_based_on_db_accounts(sk: RistrettoSecretKey, number_orders: i64, sleep_duration: u64)-> Result<String, String> {
    zkos_client_wallet::agent::auto_orders::market_order_service(sk, number_orders, sleep_duration)
}

fn settle_market_orders_based_on_db_orders(sk: RistrettoSecretKey, number_orders: i64, sleep_duration: u64)-> Result<String, String> {
    zkos_client_wallet::agent::auto_orders::settle_market_orders_service(sk, number_orders, sleep_duration)
}
