...
fn main() {
    ...
    let _create_db_accounts1 = thread::Builder::new()
        ...
        .unwrap();
    let _create_db_accounts2 = thread::Builder::new()
    ...
    let _limit_order_service = thread::Builder::new()
    ...
    let _market_order_service = thread::Builder::new()
    ...
    let _settle_market_orders = thread::Builder::new()
